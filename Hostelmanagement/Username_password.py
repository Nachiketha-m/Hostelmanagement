...
def login():
    def login_database():
        ...
        if l!=[]:
            ...
            bcont=Button(root,text="Contact",height=1,width=13,bg='black',fg='white',font='Bold',command=f.newwindow4).pack()
    ...
    global mn,lmn
    login_window.geometry('1000x630')
